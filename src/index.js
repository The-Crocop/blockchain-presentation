...
import Earth from './assets/images/earch.png';
import './style.css';
...
(function () {
    ...
    Reveal.initialize({
      ...
      parallaxBackgroundImage: Earth, // e.g. "'https://s3.amazonaws.com/hakim-static/reveal-js/reveal-parallax-1.jpg'"
